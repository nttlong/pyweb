...
class privileges():
    ...
    def View(*args, **kwargs):
        return __resolve_mapper__("view",*args,**kwargs)
    @staticmethod
    def Insert(*args,**kwargs):
        return __resolve_mapper__ ("insert", *args, **kwargs)
    @staticmethod
    def Update(*args, **kwargs):
        return __resolve_mapper__ ("update", *args, **kwargs)
    @staticmethod
    def Delete(*args, **kwargs):
        return __resolve_mapper__ ("delete", *args, **kwargs)
    @staticmethod
    def Delete(*args, **kwargs):
        return __resolve_mapper__ ("view", *args, **kwargs)
    @staticmethod
    def Publish(*args, **kwargs):
        return __resolve_mapper__ ("publish", *args, **kwargs)
    @staticmethod
    def Print(*args, **kwargs):
        return __resolve_mapper__ ("print", *args, **kwargs)
    @staticmethod
    def Export(*args, **kwargs):
        return __resolve_mapper__ ("export", *args, **kwargs)

    @staticmethod
    def Import(*args, **kwargs):
        return __resolve_mapper__ ("import", *args, **kwargs)
    @staticmethod
    def Custom(privilege):
        return __resolve_mapper__ (privilege, *args, **kwargs)
